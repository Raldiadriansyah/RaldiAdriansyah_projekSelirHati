...
@section('content')
                        ...
                        <div class="card-body">
                            <div class="card-title d-flex align-items-start justify-content-between mb-3">
                                <div class="avatar flex-shrink-0">
                                    <img src="/sneat/assets/img/icons/unicons/wallet-info.png" alt="chart success"
                                        class="rounded">
                                </div>
                                <div class="dropdown">
                ...
                <div class="col-lg-3 col-md-6 col-12 mb-4" style="height: 210px">
                    <div class="card h-100">
                        <div class="card-body">
                            <div class="card-title d-flex align-items-start justify-content-between mb-3">
                                <div class="avatar flex-shrink-0">
                                    <img src="/sneat/assets/img/icons/unicons/wallet.png" alt="chart success"
                                        class="rounded">
                                </div>
                                <div class="dropdown">
                                    <button class="btn p-0" type="button" id="cardOpt3" data-bs-toggle="dropdown"
                    ...
                    <div class="card h-100">
                        <div class="card-body">
                            <div class="card-title d-flex align-items-start justify-content-between mb-4">
                                <div class="avatar flex-shrink-0">
                                    <img src="/sneat/assets/img/icons/unicons/cc-success.png" alt="paypal"
                                        class="rounded">
                                </div>
                            </div>
                ...
                <div class="col-lg-3 col-md-6 col-12 mb-4" style="height: 210px">
                    <div class="card h-100">
                        <div class="card-body">
                            <div class="card-title d-flex align-items-start justify-content-between mb-4">
                                <div class="avatar flex-shrink-0">
                                    <img src="/sneat/assets/img/icons/unicons/cc-warning.png" alt="paypal"
                                        class="rounded">
                                </div>
                            </div>
    ...
    <div class="row" >
        ...
        <!-- Displaying Sales Based on Order Status -->
        <div class="col-xl-6 col-lg-7 mb-4">
            <div class="row">
                <div class="col-lg-3 col-md-6 col-12 mb-4" style="height: 110px; width: 300px">
                    <div class="card h-100">
                        <div class="card-body">                            
                            <p class="mb-1" style="font-size: 15px"><b>Minuman-kopi</b></p>
                            <small class=" fw-medium" style="font-size: 23px; color: #DC143C"><i
                                    class=''></i>{{ $menu->where('kategori', 'minuman-kopi')->count() }}</small>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 col-12 mb-4" style="height: 110px; width: 300px">
                    <div class="card h-100">
                        <div class="card-body">                            
                            <p class="mb-1" style="font-size: 15px"><b>Minuman-Teh</b></p>
                            <small class="fw-medium" style="font-size: 23px; color: #FF8C00"><i
                                    class=''></i>{{ $menu->where('kategori', 'minuman-teh')->count() }}</small>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 col-12 mb-4" style="height: 110px; width: 300px">
                    <div class="card h-100">
                        <div class="card-body">                            
                            <p class="mb-1" style="font-size: 15px"><b>Minuman-Milkshake</b></p>
                            <small class="fw-medium" style="font-size: 23px; color: #9400D3"><i
                                    class=''></i>{{ $menu->where('kategori', 'minuman-milkshake')->count() }}</small>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 col-12 mb-4" style="height: 110px; width: 300px">
                    <div class="card h-100">
                        <div class="card-body">                            
                            <p class="mb-1" style="font-size: 15px"><b>Minuman-Others</b></p>
                            <small class="fw-medium" style="font-size: 23px; color: #00FFFF"><i
                                    class=''></i>{{ $menu->where('kategori', 'minuman-others')->count() }}</small>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 col-12 mb-4" style="height: 110px; width: 300px">
                    <div class="card h-100">
                        <div class="card-body">                            
                            <p class="mb-1" style="font-size: 15px"><b>Makanan</b></p>
                            <small class="fw-medium" style="font-size: 23px; color: #0000FF"><i
                                    class=''></i>{{ $menu->where('kategori', 'makanan')->count() }}</small>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 col-12 mb-4" style="height: 110px; width: 300px">
                    <div class="card h-100">
                        <div class="card-body">                            
                            <p class="mb-1" style="font-size: 15px"><b>Lainnya</b></p>
                            <small class=" fw-medium" style="font-size: 23px; color: #7FFF00"><i
                                    class=''></i>{{ $menu->where('kategori', 'lainnya')->count() }}</small>
                        </div>
                    </div>
                </div>
        ...
        @section('scripts')
            <script>
                ...
                document.addEventListener('DOMContentLoaded', (event) => {
                    ...
                    const labels = ['minuman-kopi', 'minuman-teh', 'minuman-milkshake', 'minuman-others', 'makanan',
                        'lainnya'
                    ];

                    // Sum the totals based on the status (baru, diproses, selesai)
                    const values = labels.map(kategori => {
                        const total = chartData.filter(item => item.kategori === kategori).reduce((sum, item) =>
                            sum + item.total, 0);
                        return total;
                    });
                    ...
                    const data = {
                        ...
                        datasets: [{
                            data: values,
                            backgroundColor: ['#DC143C', '#FF8C00', '#9400D3', '#00FFFF', '#0000FF',
                                '#7FFF00'],
                            hoverBackgroundColor: ['#DC143C', '	#FF8C00', '#9400D3', '#00FFFF', '#0000FF',
                                '#7FFF00'
                            ],
